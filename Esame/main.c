...
#define MAX_BOLLE 7     //numero di bolle massime con cui popolare la matrice
...
int main()
{
    ...
    bonus = difficolta();    //seleziona la difficoltà del gioco
    pulisci();
    attendi();
    ...
    do
    {
        ...
        contMB = soluzione(griglia, RIGHE, COLONNE);  //contatore delle mosse da battere
        ...
        do
        {
            ...
            scanf("%d", &rigaIns);
            if (rigaIns >= 0 && rigaIns < RIGHE){}else{
            ...
            scanf("%d", &colIns);
            if (colIns >= 0 && colIns < COLONNE){}else{
                printf("Errore! Hai inserito un numero fuori dalla griglia, sprecherai la mossa!\n");
            }
            spazio();
            ...
            if (grigliaMod[rigaIns][colIns] == 1){ //caso: colpito un 1 --> esplosione
            ...
            } else if (grigliaMod[rigaIns][colIns] == 2){ //caso: colpito un 2 --> -1
                printf("Hai colpito una bolla gonfia a meta'! Ora e' in procinto di esplodere.\n");
                grigliaMod[rigaIns][colIns]--;
            } else if (grigliaMod[rigaIns][colIns] == 3){  //caso: colpito un 3 --> -1
    ...
    void regole(){
        ...
        printf("Facendo esplodere una bolla in procinto di esplodere creerai un'esplosione che si propaghera' nelle quattro direzioni!\n");
